...
<div class="bjui-pageContent">
     <form action="${pageContext.request.contextPath}/admin/user/add" data-toggle="validate" data-reload-navtab="true" data-alertmsg="false">
                 ...
                 <tbody>
                       <tr>
                           <td colspan="2">
                               ...
                               <input type="text" id="username" name="username" value="${user.username}" size="60" data-rule="required;remote[${pageContext.request.contextPath}/admin/user/checkAccount]" >
                       ...
                       <tr>
                           <td colspan="2">
                               <label class="control-label x100"><i class="fa fa-asterisk" aria-hidden="true"></i>电话：</label>
                           ...
                           <td colspan="2">
                               ...
                               <option value="">请选择实验室</option>
                                   <c:forEach var="lab" items="${labs}">
                                       <option value="${lab.labid}" <c:if test="${lab.labid == user.labid}" > selected</c:if>> ${lab.labname}</option>
                                   </c:forEach>
                           </select>
         ...
         <div class="bjui-pageFooter">
             <ul>
                 ...
                 <li><button type="submit" class="btn-default" data-icon="save">添加用户</button></li>
             </ul>
         </div>
     </form>
</div>
