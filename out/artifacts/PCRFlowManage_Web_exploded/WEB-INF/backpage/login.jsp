...
<div class="main_box">
        ...
        <div class="login_form">
            ...
            <form action="${pageContext.request.contextPath}/admin/login" id="login_form" method="post">
                ...
                <div class="form-group">
                    <label for="j_username" class="t">用户名：</label> <input id="j_username" value="" name="name" type="text" class="form-control x319 in" autocomplete="off">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="t"></label>
                    <label for="j_remember" class="m"><input id="j_remember" name="rememberMe" type="checkbox" value="true">&nbsp;记住登陆账号!</label>
                </div>
    ...
    <div class="bottom">Copyright &copy; 2016 - 2017 <a href="#">武汉理工大学计算机科学与技术学院</a></div>
</div>
</body>
</html>